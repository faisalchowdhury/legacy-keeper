...
export default function FeaturesSection() {
  ...
  const paths = [
    "/features/digital-will",
    "/features/asset-management",
    "/features/funeral-wishes",
    "/features/executor-management",
    "/features/secure-access",
    "/features/device-storage",
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {t.features.items.map((feature, index) => (
            ...
            >
              ...
              <p className="text-[#6b7280] leading-relaxed mb-4">{feature.desc}</p>
