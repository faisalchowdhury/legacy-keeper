  ...
  return (
    <div className="landing-page bg-white">
      ...
      <div className="main pt-30">
        {/* Hero Section - Two Column Flex Layout with Parallax */}
            ...
            <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
              ...
              <div className="flex-1 w-full lg:w-1/2 animate-fadeInUp">
                ...
                <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-extrabold leading-tight mb-8 tracking-tight text-[#1e2332]">
                  Secure Your{" "}
                  <span className="gradient-text-animated">Legacy.</span>
                  <br />
                ...
                <p className="text-lg sm:text-xl text-[#6b7280] mb-12 leading-relaxed max-w-2xl">
                  The only will and estate planning app that keeps your most
                ...
                <div className="flex flex-wrap gap-6 lg:gap-8">
                  <div className="flex items-center gap-3 px-4 py-2 bg-white rounded-full border border-[#e2e8f0] shadow-sm">
                    ...
                    <span className="text-sm font-medium text-[#1e2332]">
                      100% Local Storage
                    </span>
                  </div>
                  <div className="flex items-center gap-3 px-4 py-2 bg-white rounded-full border border-[#e2e8f0] shadow-sm">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative z-10">
            <div className="text-center max-w-3xl mx-auto mb-20">
              ...
              <p className="text-lg text-[#6b7280] leading-relaxed">
                Comprehensive tools to document your legacy, wishes, and ensure
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
              {[
                ...
                <div
                  key={index}
                  className="feature-card-premium group p-8 bg-white border border-[#e2e8f0] rounded-2xl transition-all duration-300 hover:border-accent/50 hover:-translate-y-2 hover:shadow-glow cursor-pointer"
                >
        ...
        {/* How It Works - Premium Two Column Layout */}
        <section className="how-it-works-section py-24 lg:py-32 relative overflow-hidden bg-white">
          ...
          <div className="grid-pattern absolute inset-0 opacity-100"></div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative z-10">
            ...
            <div className="text-center mb-20">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6 text-[#1e2332]">
                How <span className="gradient-text">Legacy Keeper</span> Works
              </h2>
              <p className="text-lg text-[#6b7280] max-w-2xl mx-auto">
                Four simple steps to secure your legacy and protect your loved
                ones
              </p>
            </div>
              ...
              {[
                ...
                >
                  ...
                  <div className="relative flex items-start gap-6 mb-6">
                    <div
                      className={`flex-shrink-0 w-16 h-16  rounded-2xl flex items-center justify-center text-2xl font-bold shadow-glow-sm transition-transform duration-500 group-hover:scale-110 group-hover:rotate-3`}
                    >
                      {step.num}
                    </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-lg text-[#6b7280] leading-relaxed mb-12">
                  Unlike other services, Legacy Keeper never uploads your data
                  to any server. Everything you document stays encrypted on your
                  device, giving you complete control and absolute privacy.
                </p>
                <div className="space-y-6">
                  {[
                    ...
                    >
                      ...
                      <span className="text-[#4b5563] group-hover:text-accent transition-colors">
                        {item}
                      </span>
                    </div>
                  ))}
              ...
              <div className="hidden lg:flex justify-center items-center">
                <div className="shield-icon w-[300px] h-[300px] flex items-center justify-center animate-rotate-slow">
                  <svg
                    ...
                    fill="currentColor"
                    style={{
                      filter: "drop-shadow(0 0 30px rgba(27, 110, 243, 0.2))",
                    }}
                  >
        ...
        <section
          id="download"
          className="py-24 lg:py-32 bg-gradient-to-br from-[#1b6ef3] to-[#00b4f0] text-center relative overflow-hidden"
        >
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative z-10">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-8 text-white">
              Start Securing Your{" "}
              <span className="text-white/90">Legacy Today</span>
            </h2>
            <p className="text-xl text-white/80 mb-12 max-w-2xl mx-auto">
              Download Legacy Keeper and take the first step in protecting what
              matters most.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <div className="text-xl font-semibold text-[#1e2332]">
                    App Store
                  </div>
                </div>
              </a>
